...
For conditional training we conditioned on the emotion class with 10% CFG dropout. Samples were generated with a CFG value of 4.0. Conditional training was done with the unconditional weights as a starting point. 
